    ...
    config = function()
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Show lsp's incoming call hierarchy in litee
          map('<leader>ch', require('telescope.builtin').lsp_incoming_calls, '[C]ode [H]ierarchy Incoming')

          -- Show lsp's outgoing call hierarchy in litee
          map('<leader>cH', require('telescope.builtin').lsp_outgoing_calls, '[C]ode [H]ierarchy Outgoing')
          ...
          map('<leader>rn', renameFunc, '[R]e[n]ame')
